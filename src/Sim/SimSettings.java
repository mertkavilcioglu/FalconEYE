...
public final class SimSettings {
    ...
    public static final double SPAWN_MIN_ALTITUDE_FT = 4000.0;
    public static final double SPAWN_MAX_ALTITUDE_FT = 30000.0;
    public static final double SPAWN_CLOSE_ALTITUDE_OFFSET_FT = 5000.0;
    public static final double SPAWN_MEDIUM_ALTITUDE_OFFSET_FT = 10000.0;
    public static final double SPAWN_LONG_ALTITUDE_OFFSET_FT = 14000.0;
